...
},
{
  ...
  "ingredients": [
    ...
    { "name": "Whole Milk for Filling", "amount": 1000, "unit": "ml", "notes": "for rice porridge" },
    { "name": "Water for Rice", "amount": 250, "unit": "ml", "notes": "for cooking rice" },
    { "name": "Salt for Filling", "amount": 1, "unit": "tsp", "notes": "for rice mixture" },
    { "name": "Butter for Filling", "amount": 2, "unit": "tbsp", "notes": "for finishing the porridge" },
    { "name": "Rye Flour", "amount": 250, "unit": "g", "notes": "for pastry dough" },
    { "name": "All-Purpose Flour", "amount": 125, "unit": "g", "notes": "for pastry dough" },
    { "name": "Water for Dough", "amount": 250, "unit": "ml", "notes": "lukewarm" },
    { "name": "Salt for Dough", "amount": 1, "unit": "tsp", "notes": "for pastry" },
    { "name": "Hard-Boiled Eggs", "amount": 4, "unit": "large", "notes": "for egg butter (munavoi)" },
    { "name": "Butter for Egg Mixture", "amount": 100, "unit": "g", "notes": "softened, for egg butter" },
    { "name": "Salt for Egg Butter", "amount": 0.25, "unit": "tsp", "notes": "for egg butter mixture" },
    { "name": "Butter for Brushing", "amount": 50, "unit": "g", "notes": "melted, mixed with a splash of hot milk" }
  ],
  "instructions": [
  ...
  "notes": [
    "The rice porridge filling must be completely cool before assembling the pies to prevent the dough from becoming soggy.",
    "Rolling the dough extremely thin is crucial - you should almost be able to see through it.",
    "The characteristic ridged edges are created by pinching and crimping with your fingers - this takes practice to perfect.",
    "The very high baking temperature is traditional and creates the right texture - don't be tempted to lower it.",
    "Brushing with the butter-milk mixture immediately after baking is essential for the right texture and flavor.",
    "Leftover pies can be frozen and reheated in the oven.",
    "Traditional Karelian pies use 100% rye flour, but the addition of all-purpose flour makes them easier to work with.",
    "The egg butter should be at room temperature when serving."
  ],
  "nutritionFacts": {
    "protein": 6,
    "carbs": 24,
...
},
{
  ...
  "ingredients": [
    ...
    { "name": "Olive Oil for Stew", "amount": 60, "unit": "ml", "notes": "for cooking vegetables" },
    ...
    { "name": "Salt for Stew", "amount": 1, "unit": "tsp", "notes": "to taste" },
    { "name": "Black Pepper", "amount": 0.5, "unit": "tsp", "notes": "freshly ground" },
    { "name": "Baguette", "amount": 1, "unit": "loaf", "notes": "sliced and toasted, for serving" },
    { "name": "Garlic for Rouille", "amount": 4, "unit": "cloves", "notes": "minced" },
    ...
    { "name": "Olive Oil for Rouille", "amount": 120, "unit": "ml", "notes": "extra virgin" },
    { "name": "Saffron for Rouille", "amount": 0.25, "unit": "tsp", "notes": "soaked in 1 tbsp hot water" },
    { "name": "Lemon Juice", "amount": 2, "unit": "tsp", "notes": "fresh" },
    { "name": "Salt for Rouille", "amount": 0.25, "unit": "tsp", "notes": "or to taste" }
  ],
  "instructions": [
