          ...
          <Dialog as="div" className="relative z-10" initialFocus={modalContentRef} onClose={onClose}>
            ...
            <div className="fixed inset-0 z-10 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4">
                ...
                <Transition.Child as="div" enter="ease-out duration-300" enterFrom="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enterTo="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leaveFrom="opacity-100 translate-y-0 sm:scale-100" leaveTo="opacity-100 translate-y-4 sm:translate-y-0 sm:scale-95">
                  <Dialog.Panel id="recipe-modal-content" className="relative transform rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl max-h-[90vh] overflow-y-auto flex flex-col">
                    ...
                    {/* Content Wrapper */}
                    <div ref={modalContentRef} className="px-4 sm:px-6 py-4 flex-grow overflow-y-auto text-black">
                                    ...
                                    {recipeToDisplay.ingredients.map((ing, index) => {
                                      ...
                                      return (
                                        <div key={ingredientIdentifier} className="flex items-start space-x-3">
                                          <Checkbox id={checkboxId} checked={selectedIngredients.has(ingredientIdentifier)} onCheckedChange={() => handleIngredientToggle(ingredientIdentifier)} className="mt-1 border border-black" aria-labelledby={`${checkboxId}-label`} />
